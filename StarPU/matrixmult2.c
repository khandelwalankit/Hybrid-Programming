...
static unsigned int nslicex = 32;
static unsigned int nslicey = 32;
static unsigned xdim = 4096;
static unsigned ydim = 4096;
static unsigned zdim = 4096;


//Creating CUDA function To perform matrix calculation
void matrix_cuda_func(void *buffers[], void *_args)
{
...
{ 
  ...
  time_t start;
  start=time(0);
  //printf("Start Time %c",ctime(&start));
