...
for i in `seq 1 $max`
  do
    ...
    ./matrixmult_tbb 4 4 2048 2048 2048 >> testresult_matrixmult.txt
    echo "Running matrix multiplication for 2048X2048 and dividing in block of 256X256" >> testresult_matrixmult.txt
    ./matrixmult_tbb 8 8 2048 2048 2048 >> testresult_matrixmult.txt
    ...
    ./matrixmult_tbb 8 8 4096 4096 4096 >> testresult_matrixmult.txt
